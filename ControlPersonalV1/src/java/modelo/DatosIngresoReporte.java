 ...
 * @author ADMIN
 */
public class DatosIngresoReporte {
    ...
    private String nombreempleadoingreso;

    public DatosIngresoReporte() {
    }
    ...
    public String getNombreempleadoingreso() {
        return nombreempleadoingreso;
    }

    public void setNombreempleadoingreso(String nombreempleadoingreso) {
        this.nombreempleadoingreso = nombreempleadoingreso;
    }
